...
public class FallRecovery : MonoBehaviour
{
    ...
    public Transform RecoveryPoint2;
    public Transform RecoveryPoint3;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        collision.gameObject.transform.position = RecoveryPoint2.position;
        collision.gameObject.transform.position = RecoveryPoint3.position;
    }
}
